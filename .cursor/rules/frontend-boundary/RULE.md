...
## 3) Conventions
- Follow existing Next.js conventions and project structure already in this repo.
...
## 7) Component Development & Testing
...
- **Verify**: accessibility (A11y) and responsive behavior across screen sizes.
